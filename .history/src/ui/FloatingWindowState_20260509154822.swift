...
final class FloatingWindowState: ObservableObject {
  ...
  func updateDrag(petAnchor: CGPoint) {
    ...
    print("=== DRAG DEBUG ===")
    print("petAnchor (SwiftUI coords): \(petAnchor)")
    print("window.frame: \(window.frame)")
    print("visibleFrame: \(visibleFrame)")
    print("screenFrame: \(screenFrame)")
    print("newOrigin (before clamp): \(newOrigin)")
    ...
    print("petScreen position: (\(petScreenX), \(petScreenY))")
